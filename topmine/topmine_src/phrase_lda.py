...
class PhraseLDA(object):
    ...
    def __init__(self, partitioned_docs, index_vocab, 
                 ...
                 optimization_iterations=1000, optimization_burnin=50):
        # initialize corpus
    ...
    def _init_histogram(self):
        # max_documents_words_count: so luong tu cua van ban dai nhat
        # document_histogram: luu cac doc co cung length, length = 200 thi co 10 doc
    ...
    def run(self):
        ...
        return self.documents_phrases_topic, self._getMostFrequentPhrasalTopics(topics), self.n_d_t_phrases, topics
